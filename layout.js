...
{   let [input, setInput] = useState('0');
    ...
    return(
        ...
        <div className='frame'>
            <br></br>
            <img src={logo} width='150px' className='image'></img>
            <Output user={input} answer={result}></Output>
            <div className='calculator'>
                <div className='keys'>
                        <input type='button' value='C' className='button clear' onClick={handleClick}></input>
                        <input type='button' value='DEL' className='button delete' onClick={handleClick}></input>
                        ...
                        <input type='button' value='.' className='button operator' onClick={handleClick}></input>
                        <input type='button' value='=' className='button equal-sign' onClick={handleClick}></input><br></br>
